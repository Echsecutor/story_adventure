 ...
 */
export function useHotkeys({ onBack, onForward, onFullscreen, onToggleText, onShowHelp, onSaveProgress, onLoadProgress, story, enabled, }) {
     ...
     */
    const getHotkeyDefinitions = useCallback(() => {
        return {
            b: {
            ...
            l: {
                description: 'Load progress for the current adventure. (load the adventure first)',
